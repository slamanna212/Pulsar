...
export const cssVariablesResolver: CSSVariablesResolver = () => ({
  ...
  light: {
    ...
    '--app-shadow-card': '0 1px 2px rgba(90,60,180,.08), 0 10px 20px -5px rgba(90,60,180,.14), 0 30px 60px -20px rgba(90,60,180,.16)',
  ...
  dark: {
    ...
    '--app-shadow-card': '0 1px 2px rgba(0,0,0,.3), 0 10px 20px -5px rgba(0,0,0,.35), 0 30px 60px -20px rgba(0,0,0,.4)',
    '--app-glass-bg': 'linear-gradient(180deg, rgba(20,18,32,.94), rgba(10,9,17,.9))',
  },
});
